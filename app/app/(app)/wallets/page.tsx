    ...
    <div className="flex flex-col gap-[10px]">
      ...
      {contributors.map((c, i) => {
        ...
        return (
          <div
            key={c.mbid}
            className={`pp-card ${c.is_escrow ? 'border-[var(--border-warning)]' : 'border-[var(--border-success)]'}`}
          >
            <div className="flex items-center gap-[10px] mb-[10px]">
              ...
              {c.is_escrow ? (
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-[var(--bg-warning)] text-[var(--text-warning)] font-medium">escrow</span>
              ) : null}
            </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="bg-[var(--surface-1)] rounded-[var(--radius)] p-2">
                ...
                <div className="text-[10px] text-[var(--text-muted)] mt-0.5">Tx settled</div>
              </div>
            </div>
